...
<section class="container-fluid">
    ...
    <div class="home-slider home-slider-2">
        ...
        <div id="sync1" class="owl-carousel owl-carousel-2">
            <?php
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <p class="entry-excerpt"><?php print $desc ?></p>
                                    <a href="<?php print $link['url'] ?>" class="kopa-button pink-button large-button"><?php print $link['title'] ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
