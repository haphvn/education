...
$field_gallerys = field_get_items('node', $node, 'field_gallery');
...
<div class="entry-box">
    ...
    <div class="entry-content">
        ...
        <?php print (!empty($field_body_prefix)) ? $field_body_prefix[0]['value'] : '' ?>
        <br>

        <div class="owl-carousel owl-carousel-6">
            <?php
            foreach ($field_gallerys as $field_gallery) :
                ?>
                <div class="item">
                    <a href="#">
                        <?php
                        ...
                        print theme('image_style', $blog_image);
                        ?>
                    </a>
                </div>
            <?php endforeach ?>
