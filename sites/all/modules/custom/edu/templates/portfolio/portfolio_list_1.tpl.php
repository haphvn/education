                        ...
                        <div class="portfolio-container">
                            ...
                            <ul class="portfolio-list-item clearfix">
                                ...
                                foreach ($nodes as $node) :
                                    ...
                                    ?>
                                    <li class="por-item1 col-md-6 col-sm-6 col-xs-12"
                                            ...
                                            <div class="entry-thumb">
                                                ...
                                                foreach ($field_image as $item) {
                                                    $image = array(
                                                        ...
                                                        'alt' => $item['alt'],
                                                        'title' => $item['title'],
                                                        'style_name' => 'portfolio_large__540x331_'
                                                    );
                                    ...
                                    <span class="entry-categories">
                                        ...
                                        <?php endforeach ?>
                                                ...
                                                <h6 class="entry-title"><a href="<?php print url('node/'.$node->nid) ?>"><?php print $title ?></a></h6>
                                            </div>
                                        </article>
                                    </li>
                                <?php endforeach ?>
